...
def menu_alumno(request):
    ...
    if request.method == 'GET' and 'ejercicio_id' in request.GET:
        ...
        if datetime.now() > ejercicio.fecha_entrega:
            ...
            messages.warning(request, mensaje_fecha_pasada)
...
# Función login, autenticación, etc. siguen igual

# Nota: No es necesario duplicar el código, ya que el enfoque es asegurar que datetime.now() funcione correctamente.
