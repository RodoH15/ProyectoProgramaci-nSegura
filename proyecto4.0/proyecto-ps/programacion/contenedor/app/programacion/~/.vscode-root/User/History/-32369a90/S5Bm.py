...
from .views import login, ver_respuestas, eliminar_ejercicio, ver_puntajes_alumno, ejercicio_cerrado, registro, ver_resultado, registro_exitoso, autenticacion, ingresar_codigo_acceso, menu_maestro, menu_alumno, logout_view, crear_ejercicio, listar_ejercicios, detalle_ejercicio, subir_respuesta, ver_respuestas, detalle_respuesta, ver_puntajes
...
urlpatterns = [
    ...
    path('ver_resultado/<int:respuesta_id>/', ver_resultado, name='ver_resultado'),
    path('login/', auth_views.LoginView.as_view(template_name='login.html'), name='login'),
    path('logout/', auth_views.LogoutView.as_view(), name='logout'),
    path('ejercicio_cerrado/<int:ejercicio_id>/', ejercicio_cerrado, name='ejercicio_cerrado'),
    path('ver_puntajes_aluumno/', ver_puntajes_alumno , name='ver_puntajes_alumno'),
