...
def menu_alumno(request):
    ...
    for ejercicio in ejercicios:
        if ejercicio.fecha_entrega < timezone.now():
            mensajes.append(f"La fecha de entrega ha pasado para el ejercicio {ejercicio.nombre_ejercicio}. No puedes subir respuestas.")

    return render(request, 'menu_alumno.html', {'ejercicios': ejercicios, 'mensajes': mensajes})
