...
class RespuestaEjercicio(models.Model):
    ...
    fecha_subida = models.DateTimeField(auto_now_add=True)  # Almacena la hora de subida automáticamente
    codigo_archivo = models.TextField()  # Almacena el código del estudiante
