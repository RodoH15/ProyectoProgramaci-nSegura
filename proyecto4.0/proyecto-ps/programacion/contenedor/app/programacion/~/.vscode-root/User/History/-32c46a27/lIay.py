...
def evaluar_con_casos_directos(code_path, casos_path, respuesta_id):
    comando = f"docker exec -i programacion-programacion-executor-1-1 python3 /code/programacion/scripts/scripts.py {code_path} {casos_path} {respuesta_id}"
...
def calcular_puntaje(resultados):
    ...
    return (correctos / total) * 100 si total > 0 else 0
...
if __name__ == '__main__':
    ...
    task_id = add_task_to_queue(code_path, casos_path, respuesta_id)
