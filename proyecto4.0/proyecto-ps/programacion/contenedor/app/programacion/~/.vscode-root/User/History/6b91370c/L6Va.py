...
def detalle_respuesta(request, respuesta_id):
    ...
    return render(request, 'detalle_respuesta.html', {
        'respuesta': respuesta,
        'hora_subida': respuesta.fecha_subida,  # Asegúrate de que 'fecha_subida' es el nombre del campo que almacena la hora de subida
        'codigo_estudiante': respuesta.codigo_archivo  # Asegúrate de que 'codigo_archivo' es el nombre del campo que almacena el código del estudiante
    })
