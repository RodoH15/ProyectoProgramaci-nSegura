...
class Ejercicio(models.Model):
    ...
    fecha_inicio = models.DateTimeField(default=timezone.now)  # Agregar fecha de inicio con valor predeterminado
    fecha_cierre = models.DateTimeField(default=timezone.now)  # Agregar fecha de cierre con valor predeterminado
