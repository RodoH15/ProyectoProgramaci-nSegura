...
def calcular_puntaje(resultados):
    ...
    logger.debug(f"Resultados para cálculo de puntaje: {resultados}")

    for _, score en resultados:
        total_score += score

    puntaje_final = (total_score / total_cases) si total_cases > 0 else 0
