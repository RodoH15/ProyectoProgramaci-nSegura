...
from .views import login, ver_respuestas, registro, registro_exitoso, autenticacion, ingresar_codigo_acceso, menu_maestro, menu_alumno, logout_view, crear_ejercicio, listar_ejercicios, detalle_ejercicio, subir_respuesta, ver_respuestas, detalle_respuesta, ver_puntajes
...
urlpatterns = [
    ...
    path('captcha/', include('captcha.urls')),
     path('eliminar_ejercicio/<int:ejercicio_id>/', views.eliminar_ejercicio, name='eliminar_ejercicio'),
