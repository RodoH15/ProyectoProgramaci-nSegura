...
def subir_respuesta(request, ejercicio_id):
    ...
    casos_de_prueba_path = f'/code/test_case/casos_de_prueba_{ejercicio.id}.txt'
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Escribir los casos de prueba en el contenedor executor
            try:
                with open(f'./test_case/casos_de_prueba_{ejercicio.id}.txt', 'w') as f:
                    f.write(casos_de_prueba)
                os.system(f'docker cp ./test_case/casos_de_prueba_{ejercicio.id}.txt programacion_executor_1:/code/test_case/')
