...
class EjercicioForm(forms.ModelForm):
    ...
    fecha_cierre = forms.DateTimeField(widget=forms.DateTimeInput(attrs={'type': 'datetime-local'}))

    class Meta:
        model = Ejercicio
        fields = ['nombre', 'descripcion', 'fecha_inicio', 'fecha_cierre']
...
class EjercicioForm(forms.ModelForm):
    ...
    fecha_cierre = forms.DateTimeField(widget=forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'form-control'}))

    class Meta:
        model = Ejercicio
        fields = ['nombre_ejercicio', 'descripcion_ejercicio', 'fecha_inicio', 'fecha_cierre']
