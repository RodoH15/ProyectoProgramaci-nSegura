...
def evaluar_con_casos_directos(code_path, casos_de_prueba):
    ...
    print(f"Comando de evaluación: {comando}")  # Añadir un mensaje de depuración para verificar el comando
    result = subprocess.run(comando, shell=True, capture_output=True, text=True)
    print(f"Salida del comando de evaluación: {result.stdout}")  # Añadir un mensaje de depuración para verificar la salida
