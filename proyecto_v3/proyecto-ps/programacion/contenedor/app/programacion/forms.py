...
class EjercicioForm(forms.ModelForm):
    fecha_inicio = forms.DateTimeField(widget=forms.TextInput(attrs={'placeholder': 'YYYY-MM-DD HH:MM:SS'}))
    fecha_entrega = forms.DateTimeField(widget=forms.TextInput(attrs={'placeholder': 'YYYY-MM-DD HH:MM:SS'}))

    class Meta:
        model = Ejercicio
        fields = ['nombre_ejercicio', 'descripcion_ejercicio', 'fecha_inicio', 'fecha_entrega', 'casos_de_prueba']  # Incluye el campo de casos de prueba
