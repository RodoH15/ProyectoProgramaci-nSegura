    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if 'codigo_archivo' in request.FILES:
                ...
                archivo_path = os.path.join('/tmp', archivo.name)  # Guardar temporalmente
                ...
                respuesta.codigo_archivo = f'/code/submissions/{archivo.name}'  # Ruta en el contenedor executor
            ...
            try:
                ...
                messages.error(request, f'Archivo no permitido: {str(e)}')
                return render(request, 'subir_respuesta.html', {'form': form, 'ejercicio': ejercicio, 'casos_de_prueba': casos_de_prueba})
