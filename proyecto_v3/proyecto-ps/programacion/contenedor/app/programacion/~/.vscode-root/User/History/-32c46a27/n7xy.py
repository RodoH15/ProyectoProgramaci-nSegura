...
def analizar_codigo(codigo):
    lineas_peligrosas = ['import os', 'subprocess.Popen']
...
def inyect(programa, entrada, maxTime=5):
    ...
    with open(log_path, "a") as log_file:
        try:
            ...
            process = subprocess.Popen(["docker", "exec", "-i", "programacion-executor-1"] + programa.split(), stdout=subprocess.PIPE, stdin=subprocess.PIPE, stderr=subprocess.PIPE)
